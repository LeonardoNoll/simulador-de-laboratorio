function spawn_tool_tip(name){
	if !(instance_exists(obj_context_menu) || instance_exists(obj_text_box) || instance_exists(obj_inventory_GUI)
	|| instance_exists(obj_locker_GUI) || instance_exists(obj_reference_table) || instance_exists(obj_instructions)
