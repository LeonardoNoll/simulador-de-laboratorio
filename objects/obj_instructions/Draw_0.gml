...
if(_parent.instruction < array_length(instructions) - 1 && !instance_exists(obj_next_reference)) {
...
var _text_x = x-70
var _text_y = y-80
var _display_text = string(_parent.instruction+1) + ". " + instructions[_parent.instruction]
var _text_width = 150
var _separation = 20
var _scale = 1
var _angle = 5
